...
void densmatr_OneQubitChannel(Qureg qureg, const int targetQubit, OneQubitSuperOperator supop);

void densmatr_TwoQubitChannel(Qureg qureg, const int qubit1, const int qubit2, TwoQubitSuperOperator supop);
